...
import { createToolRegistry, artifactTools, workflowTools, airspaceTools } from '@/lib/tools';
...
const toolRegistry = createToolRegistry([artifactTools, workflowTools, airspaceTools]);
